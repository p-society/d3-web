  ...
  return (
    <footer className="bg-gray-100 dark:bg-black">
      <div className='flex justify-center'>
        <div className=' mx-10 mt-16 grid-flow-row' >
          <img src={img02} alt="img" height={400} width={200} />
        </div>
        <div>
          <div className="mx-12 max-w-5xl px-16 py-8 sm:px-6 lg:px-8">
            <div className="flex justify-center text-teal-600 dark:text-teal-300">
              <img src={image} alt="image" height={100} width={250} />
            </div>

            <ul className="text-white mt-8 flex flex-wrap justify-center gap-3 md:gap-3 lg:gap-3">
            ...
            <ul className="text-white mt-8 flex justify-center gap-2 md:gap-2">
              <li>
                <a
          ...
          <div className="bg-black text-white p-6 rounded-lg shadow-lg max-w-md mx-auto sm:max-w-lg md:max-w-xl lg:max-w-2xl">
          ...
          <div className="mx-auto mt-8 mb-0 max-w-md text-center leading-relaxed text-gray-500 dark:text-gray-400 pb-6">
            © 2024 IIIT Bhubaneswar Tech Society. All Rights Reserved.
          </div>
        </div>
        <div className=' mx-10 pl-14 mt-16 grid-flow-row' >
