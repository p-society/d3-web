    ...
    >
      ...
      <div className="absolute w-[94.7%] h-[96.3%] left-0 top-0 bg-[#3366FF] rounded-[5vw] md:rounded-[37.5px] overflow-hidden">
        ...
        <div
          ...
          className={`absolute w-[70.2%] left-[16.7%] top-[79.1%] text-center text-[#FFEABB] text-lg sm:text-xl md:text-2xl lg:text-[30px] font-aclonica font-normal leading-tight transition-all duration-700 ease-out ${
            isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-3'
          }`}
        >
          {cardText}
