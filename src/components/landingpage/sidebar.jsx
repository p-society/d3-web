  ...
  return (
    ...
    >
      ...
      <div className="flex h-full">
        <div className="w-6 phone:w-10 sm:w-14 h-full bg-[#ff0066] border-2 border-black"></div>
        <div className="w-6 phone:w-10 sm:w-14 h-full bg-[#c6f806] border-2 border-black"></div>
        <div className="w-6 phone:w-10 sm:w-14 h-full bg-[#ff8c34] border-2 border-black"></div>
      </div>
    </div>
  )
}
